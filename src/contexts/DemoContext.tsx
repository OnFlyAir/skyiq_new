...
export const TRIP_DEMO_STEPS: DemoStep[] = [
  ...
  },
  {
    ...
    description: "In real use you'd upload a PDF here and SkyIQ extracts every flight detail. We'll load a sample now — click Next.",
    placement: 'bottom',
    action: 'click',
    autoAdvance: true,
  },
  ...
  {
    id: 'explain-leg-overview',
    page: '',
    target: 'leg-1-departure',
    title: 'Leg Details',
    description: "Each leg shows departure, destination, fuel price, and fees. SkyIQ uses these to find the cheapest fueling plan.",
    placement: 'bottom',
  },
  {
    id: 'explain-leg-fees',
  ...
  },
  {
    ...
    title: 'Fuel Burns',
    description: "We've auto-filled current fuel on board and the burn for each leg. In real use you'd enter these from your flight planner.",
    placement: 'top',
  },
  {
    id: 'expand-weights',
