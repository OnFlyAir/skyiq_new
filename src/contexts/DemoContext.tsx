...
export const TRIP_DEMO_STEPS: DemoStep[] = [
  ...
  },
  {
    ...
    description: 'Send the fuel plan to yourself, your copilot, and your company — not just a generic team inbox. Click Next to see how.',
    placement: 'top',
    action: 'click',
    autoAdvance: true,
    skipOnBack: true,
...
export const PUBLIC_DEMO_STEPS: DemoStep[] = [
  ...
  },
  {
    ...
    description: "Routes, fuel prices, passengers, weights, fees — every detail is extracted from the trip sheet (highlighted here). You just confirm each leg looks right. Click Next to continue to fuel burns.",
    placement: 'center',
  ...
  },
  {
    ...
    page: '',
    target: 'fuel-burn-leg-1',
    title: 'Enter Fuel Burns Per Leg',
    description: 'Fuel burns come straight from the filed flight plan for each leg. They are pre-filled for the demo so you can review them instantly.',
    placement: 'bottom',
  },
  {
    id: 'public-run-optimizer',
    page: '',
    target: 'confirm-trip-btn',
    title: 'Run the Optimizer',
    description: 'The optimizer happens after the fuel burn step. Click Next to generate the fuel plan.',
    placement: 'top',
    action: 'click',
    autoAdvance: true,
    skipOnBack: true,
  ...
  },
  {
    ...
    page: '',
    target: 'send-email-btn',
    title: 'Email to You, Your Copilot & Your Company',
    description: "Send the fuel plan to yourself, your copilot, and your company — so everyone who needs it has it. Click Next to see how.",
    placement: 'top',
    action: 'click',
    autoAdvance: true,
    skipOnBack: true,
