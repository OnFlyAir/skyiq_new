...
export const PUBLIC_DEMO_STEPS: DemoStep[] = [
  ...
  },
  {
    ...
    description: "Drop a PDF here and SkyIQ's AI pulls every detail — routes, prices, passengers, weights, fees. Click Next and we'll upload the sample for you.",
    placement: 'bottom',
    action: 'click',
    autoAdvance: true,
  },
  {
    id: 'wait-for-parse',
    page: '',
    title: 'Our AI Pulls the Data ✨',
    description: "SkyIQ is reading the trip sheet — routes, prices, passengers, fees, all of it.",
    placement: 'center',
    action: 'wait',
    requireAction: true,
  },
