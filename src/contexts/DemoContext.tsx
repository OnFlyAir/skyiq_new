...
export const PUBLIC_DEMO_STEPS: DemoStep[] = [
  ...
  },
  {
    ...
    description: "Routes, fuel prices, passengers, weights, fees — every detail is extracted from the trip sheet. You just confirm each leg looks right. Click Next to run the optimizer.",
    placement: 'right',
